...
> ("m/84'/0'/100'/0/0", "bc1q2urcgtc0surye2mp8rjms4xslwrpjal5u9kswr")



Paper Wallet
from btc_hd_wallet import PaperWallet
w = PaperWallet.new_wallet(bc1q2urcgtc0surye2mp8rjms4xslwrpjal5u9kswr)

# to display paper wallet in console
w.pretty_print()

# export paper wallet to csv file
w.export_to_csv(file_path="ưallet
